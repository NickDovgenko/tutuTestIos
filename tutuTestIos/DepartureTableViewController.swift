...
class DepartureTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        loadJson()
        self.title = "Станции отправления"
        ...
        if let url = Bundle.main.url(forResource: "allStations", withExtension: "json") {
            if let data = NSData(contentsOf: url) {
                do {
                    ...
                    numberOfCitiesFrom = json["citiesFrom"].count
